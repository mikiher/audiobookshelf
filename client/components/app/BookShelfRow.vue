<template>
  <div class="relative">
    <div ref="shelf" class="w-full max-w-full bookshelf-row categorizedBookshelfRow relative overflow-x-scroll no-scroll overflow-y-hidden z-10" :style="{ paddingLeft: paddingLeft * sizeMultiplier + 'rem' }" @scroll="scrolled">
      <div class="w-full h-full pt-6">
        <div v-if="shelf.type === 'book' || shelf.type === 'podcast'" class="flex items-center">
          <template v-for="(entity, index) in shelf.entities">
            <cards-lazy-book-card 
              :key="entity.id"
              :ref="`shelf-book-${entity.id}`"
              :index="index"
              :book-mount="entity"
    ...
    <div class="relative">
      <div class="relative text-center categoryPlacard transform z-30 top-0 left-4 md:left-8 w-44 rounded-md" style="height: 22px">
